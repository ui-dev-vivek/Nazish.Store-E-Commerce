                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index.html">
                                        <img src="{{asset('assets/images/nazish-logo.png')}}" class="image-fluid" alt="https://nazish.store">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            <div class="single-banner featured-banner">
                                <a href="#">
                                    <img src="{{asset('assets/images/banner/featured-banner.jpg')}}" alt="Li's Featured Banner">
                                </a>
                            </div>
                        </div>
                                            ...
                                            <div class="featured-pro-wrapper mb-30 mb-sm-25">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img alt="" src="{{asset('assets/images/featured-product/1.jpg')}}">
                                                    </a>
                                                </div>
